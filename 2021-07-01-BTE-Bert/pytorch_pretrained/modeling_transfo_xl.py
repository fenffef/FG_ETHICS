...
class TransfoXLConfig(object):
    """Configuration class.txt to store the configuration of a `TransfoXLModel`.
    """
    def __init__(self,
...
class TransfoXLPreTrainedModel(nn.Module):
    ...
    def __init__(self, config, *inputs, **kwargs):
        ...
        if not isinstance(config, TransfoXLConfig):
            raise ValueError(
                "Parameter config in `{}(config)` should be an instance of class.txt `TransfoXLConfig`. "
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, state_dict=None, cache_dir=None,
        ...
        Params:
            ...
            state_dict: an optional state dictionnary (collections.OrderedDict object) to use instead of pre-trained BE-models
...
class TransfoXLModel(TransfoXLPreTrainedModel):
    ...
    Params:
        config: a TransfoXLConfig class.txt instance with the configuration to build a new model
