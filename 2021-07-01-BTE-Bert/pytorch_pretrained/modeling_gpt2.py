...
class GPT2Config(object):
    """Configuration class.txt to store the configuration of a `GPT2Model`.
    """
...
class GPT2PreTrainedModel(nn.Module):
    ...
    def __init__(self, config, *inputs, **kwargs):
        ...
        if not isinstance(config, GPT2Config):
            raise ValueError(
                "Parameter config in `{}(config)` should be an instance of class.txt `GPT2Config`. "
    ...
    def from_pretrained(
        ...
        Params:
            ...
            state_dict: an optional state dictionary (collections.OrderedDict object) to use instead of pre-trained BE-models
            *inputs, **kwargs: additional input for the specific GPT class.txt
        """
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    Params:
        config: a GPT2Config class.txt instance with the configuration to build a new model
