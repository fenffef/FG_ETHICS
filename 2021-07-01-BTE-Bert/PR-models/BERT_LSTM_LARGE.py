...
class Config(object):
    ...
    def __init__(self, dataset):
        self.model_name = 'BERT_LSTM_LARGE'
        ...
        self.bert_path = './roberta_pretrain_l24'
        # roberta_pretrain_l24 / chinese-roberta-wwm-ext-large
...
class Model(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.fc_rnn = nn.Linear(config.rnn_hidden * 4, config.num_classes)
